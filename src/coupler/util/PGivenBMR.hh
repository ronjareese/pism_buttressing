...
#ifndef _PGIVENBMR_H_
#define _PGIVENBMR_H_
...
class PGivenBMR : public Model
{
public:
  PGivenBMR(IceGrid &g, const NCConfigVariable &conf, Input *in)
    : Model(g, conf, in) {}
...
protected:
  IceModelVec2T mass_flux;
  // IceModelVec2T temp, mass_flux;
  string filename, mass_flux_name, option_prefix;
  ...
  PetscErrorCode set_vec_parameters(string mass_flux_std_name)
