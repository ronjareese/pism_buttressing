...
PetscErrorCode PISMStressBalance::get_2D_stresses(
  ...
  PetscErrorCode ierr;
  ierr = stress_balance->compute_2D_stresses(result_Txx, result_Tyy, result_Txy, 
                                             result_Sn, result_St, result_Smag,
                                             result_Snx, result_Stx, result_Smagx,
                                             result_Sny, result_Sty, result_Smagy); CHKERRQ(ierr);
  return 0;
  }
